    ...
    <aside className="flex h-full w-[252px] shrink-0 flex-col border-r border-[#0F6B5D] bg-gradient-to-b from-[#0E7C6B] via-[#0A5C50] to-[#08473F] text-white lg:sticky lg:top-0 lg:h-screen">
      ...
      <div className="border-t border-white/10 px-3 py-3.5">
        <div className="flex items-center gap-2.5 rounded-xl bg-white/[0.06] px-2.5 py-2 ring-1 ring-white/10">
          <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-emerald-400 to-cyan-300 text-xs font-bold text-[#08473F]">AD</div>
          <div>
            <p className="text-[12px] font-semibold leading-none">Quản trị viên</p>
            <p className="mt-1 text-[10px] text-white/55">admin@dcp.vn</p>
          </div>
          <button
            type="button"
            onClick={onLogout}
